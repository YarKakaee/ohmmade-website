...
export default function Footer() {
	return (
		<footer className="bg-[#101014] border-t border-[#2C2C2E] relative w-full py-8">
			<LayoutContainer>
				<div className="flex flex-col sm:flex-row items-center justify-between space-y-6 sm:space-y-0 text-[#FFFFFF]/70 text-sm">
					{/* Left: Copyright */}
					<p>
