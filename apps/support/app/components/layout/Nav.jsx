				...
				<LayoutContainer className="w-full pointer-events-auto mt-4">
					...
					>
						...
						>
							...
							{/* Desktop: Back to Home + User */}
							<div className="hidden sm:flex items-center flex-shrink-0 ml-auto z-10">
							...
							{/* Mobile: Burger Menu */}
							<div className="sm:hidden flex items-center ml-auto z-10">
								<button
							...
							{user ? (
								<div className="p-4 space-y-2 border-t border-white/10">
									...
									<button
										...
										className="w-full flex items-center gap-4 p-4 text-white hover:bg-white/5 rounded-xl transition-colors text-left"
									>
										<FontAwesomeIcon
											icon={faSignOutAlt}
											className="w-5"
								...
								<div className="p-4 space-y-2 border-t border-white/10">
									...
									<button
										...
										className="w-full flex items-center gap-4 p-4 bg-[#27BBFF] text-[#101014] hover:brightness-110 rounded-xl transition-all text-left"
									>
										<FontAwesomeIcon
											icon={faUser}
											className="w-5"
