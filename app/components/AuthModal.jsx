			...
			{isOpen && (
				<>
					...
					>
						...
						>
							<div
								className="bg-[#1C1C20] rounded-2xl p-8 relative border border-[#3A3A3C]/60"
								onClick={(e) => e.stopPropagation()}
							>
								<button
									onClick={onClose}
									className="cursor-pointer absolute top-4 right-4 text-[#FFFFFF]/60 hover:text-white transition-colors"
								>
